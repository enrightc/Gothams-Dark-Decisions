...
| Hover effects during transitions | Hover effects should remain active and responsive during transition effects letting the user know that the application is still running. | Observed hover effects during transitions to ensure they remain active and responsive. | Hover effects were active and responsive during transitions, demonstrating the asynchronous nature of JavaScript event handling i.e the JS doesnt need to waitfor the transition to complete before it can respond to other events. |
